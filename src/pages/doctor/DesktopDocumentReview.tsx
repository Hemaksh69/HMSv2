...
export const DesktopDocumentReview: React.FC = () => {
  ...
  const [notes, setNotes] = useState('Note mild anemia. Will order iron panel and follow up in 2 weeks.');
  ...
  const statusConfig: Record<StatusFlag, { label: string; border: string; bg: string; text: string }> = {
    normal: { label: 'Normal', border: 'border-[#166534]/30', bg: 'bg-[#DCFCE7]', text: 'text-[#166534]' },
    review: { label: 'Review', border: 'border-[#b45309]/50', bg: 'bg-[#fef3c7]', text: 'text-[#b45309]' },
    critical: { label: 'Critical', border: 'border-[#ba1a1a]/30', bg: 'bg-white', text: 'text-[#ba1a1a]' },
  };
      ...
      <div className="flex-1 overflow-hidden p-8 flex flex-col h-[calc(100vh-64px)]">
          ...
          <div className="flex items-center gap-4 mb-6 shrink-0">
            <button
              ...
              className="w-10 h-10 rounded-full hover:bg-[#eaeef4] flex items-center justify-center text-[#3e4850] transition-colors"
            >
          ...
          <div className="flex-1 flex flex-col lg:flex-row gap-6 min-h-0">
            ...
            <div className="w-full lg:w-[60%] flex flex-col bg-white rounded-xl shadow-sm border border-[#bec8d2]/30 overflow-hidden min-h-0">
              <div className="flex items-center justify-between p-3 border-b border-[#bec8d2]/30 bg-[#f0f4fa]/50 shrink-0">
                ...
                <div className="flex items-center gap-1">
                  <button
                    ...
                    className="w-8 h-8 rounded hover:bg-[#dee3e9]/50 flex items-center justify-center text-[#3e4850] transition-colors"
                  >
                    <span className="material-symbols-outlined text-sm">zoom_out</span>
                  </button>
                  <span className="text-xs font-semibold text-[#6e7881] w-12 text-center">{zoom}%</span>
                  <button
              ...
              <div className="flex-1 bg-[#d6dae0]/20 flex justify-center p-4 md:p-8 overflow-y-auto">
                <div
                  className="bg-white w-full max-w-[800px] min-h-[1000px] shadow-sm border border-[#bec8d2]/50 rounded p-8 md:p-12 transition-transform duration-200"
            ...
            <div className="w-full lg:w-[40%] flex flex-col gap-6 min-h-0 overflow-y-auto">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-[#bec8d2]/30 p-5 shrink-0">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <button
                    onClick={() => navigate('/doctor/records')}
                    className="ml-auto text-[#0EA5E9] hover:bg-[#0ea5e9]/10 px-3 py-1.5 rounded-lg text-sm font-semibold transition-colors"
                  >
                    View Profile
                  </button>
                </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-[#bec8d2]/30 p-5 flex-1 flex flex-col">
                ...
                <div className="space-y-4 flex-1">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-[#f6faff] border border-[#bec8d2] rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#0ea5e9]/50"
                    >
                        ...
                        return (
                          <button
                            ...
                            className={`flex items-center justify-center border py-2 rounded-lg cursor-pointer text-sm font-semibold transition-colors ${
                              active ? `${cfg.border} ${cfg.bg} ${cfg.text} shadow-sm` : `${cfg.border} bg-white ${cfg.text} opacity-60 hover:opacity-100`
                            }`}
                          >
                            {cfg.label}
                          </button>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-[#f6faff] border border-[#bec8d2] rounded-lg px-3 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#0ea5e9]/50 min-h-[120px]"
                      placeholder="Add clinical remarks for the patient record..."
                    />
                  </div>
                </div>
                ...
                <div className="pt-6 mt-6 border-t border-[#bec8d2]/30 flex gap-3">
                  <button
                    ...
                    className="flex-1 px-4 py-2.5 rounded-lg border border-[#bec8d2] text-[#3e4850] font-semibold hover:bg-[#f0f4fa] transition-colors disabled:opacity-60 flex items-center justify-center gap-2"
                  >
                  ...
                  <button
                    ...
                    disabled={reviewState !== 'idle'}
                    className="flex-1 px-4 py-2.5 rounded-lg bg-[#0EA5E9] text-white font-semibold hover:bg-[#0EA5E9]/90 shadow-sm flex items-center justify-center gap-2 transition-colors disabled:opacity-60"
                  >
